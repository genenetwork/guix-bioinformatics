...
(define-public pocl
  (package
    ...
    (source (origin
              (method url-fetch)
              (uri (string-append "https://github.com/pocl/pocl/archive/" version 
                                  ".tar.gz"))
              (file-name (string-append name "-" version ".tar.gz"))
              (sha256
               (base32
                "00zh7il5mx60ingq9kf714yckxjq85f7lk5nk3bmhg5vvlkjdb4b"))))
    (native-inputs `(("autoconf" ,autoconf)
        ("automake" ,automake)
        ("gawk" ,gawk)
        ("glew" ,glew)
    ...
    (build-system cmake-build-system)
    (arguments 
     `(#:configure-flags '("-DCMAKE_BUILD_TYPE=Release" "-DDIRECT_LINKAGE=YES") 
       #:tests? #t))    
